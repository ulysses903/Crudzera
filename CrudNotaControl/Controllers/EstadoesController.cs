...
namespace CrudNotaControl.Controllers
{
    public class EstadoesController : Controller
    {
        ...
        public EstadoesController(CrudNotaControlContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Estado estado)
        {
            if (id != estado.Id)
            {
                return NotFound();
